...
Similar to Tooltip, Popover is also built with `TwPopper`. So for some duplicated attributes, please refer to the documentation of Tooltip.
...
| show-arrow                | whether a tooltip arrow is displayed or not. For more info, please refer to [TwPopper](https://github.com/element-plus/element-plus/tree/dev/packages/components/popper) | boolean         | —                                                                                                         | true                                                    |
