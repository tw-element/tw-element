...
import ConfigProvider from '@tw-element/components/config-provider'
import { CommonPicker } from '@tw-element/components/time-picker'
import Input from '@tw-element/components/input'
import zhCn from '@tw-element/locale/lang/zh-cn'
import enUs from '@tw-element/locale/lang/en'
...
describe('MonthRange', () => {
  ...
  it('should accept popper options and pass down', async () => {
    ...
    expect(
      (wrapper.findComponent(CommonPicker).vm as any).TwPopperOptions
    ).toEqual(TwPopperOptions)
  })
})
