...
export declare interface MessageBoxState {
  ...
  showCancTwButton: boolean
  action: Action
  dangerouslyUseHTMLString: boolean
  confirmButtonText: string
  cancTwButtonText: string
  confirmButtonLoading: boolean
  cancTwButtonLoading: boolean
  confirmButtonClass: string
  confirmButtonDisabled: boolean
  cancTwButtonClass: string
...
export interface TwMessageBoxOptions {
...
export type TwMessageBoxShortcutMethod = ((
  message: TwMessageBoxOptions['message'],
  title: TwMessageBoxOptions['title'],
...
export interface ITwMessageBox {
  /** Show a message box */
  // (message: string, title?: string, type?: string): Promise<MessageBoxData>

  /** Show a message box */
  (options: TwMessageBoxOptions): Promise<MessageBoxData>

  /** Show an alert message box */
  alert: TwMessageBoxShortcutMethod

  /** Show a confirm message box */
  confirm: TwMessageBoxShortcutMethod

  /** Show a prompt message box */
  prompt: TwMessageBoxShortcutMethod
