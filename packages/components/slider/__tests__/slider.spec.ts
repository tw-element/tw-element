...
describe('Slider', () => {
  ...
  it('show tooltip', () => {
    ...
    const slider: any = wrapper.findComponent({ name: 'TwSliderButton' })
  ...
  it('drag', (done) => {
    ...
    const slider = wrapper.findComponent({ name: 'TwSliderButton' })
  ...
  it('click', (done) => {
    ...
    const slider: any = wrapper.findComponent({ name: 'TwSlider' })
    setTimeout(() => {
  ...
  it('vertical mode', (done) => {
    ...
    const mockClientHeight = jest
      ...
      .mockImplementation(() => 200)
    const slider: any = wrapper.getComponent({ name: 'TwSlider' })
    setTimeout(() => {
  ...
  describe('range', () => {
    it('basic ranged slider', () => {
      ...
      const sliders = wrapper.findAllComponents({ name: 'TwSliderButton' })
