...
describe('Transfer', () => {
  ...
  it('create', () => {
    ...
    expect(wrapper.findComponent({ name: 'TwTransfer' })).toBeTruthy()
  })
  ...
  it('default target list', () => {
    ...
    const TwTransfer: any = wrapper.findComponent({ name: 'TwTransfer' })
    expect(TwTransfer.vm.sourceData.length).toBe(13)
  })
  ...
  it('filterable', async () => {
    ...
    const leftList: any = wrapper.findComponent({ name: 'TwTransferPanel' })
    leftList.vm.query = '1'
  ...
  it('transfer', async () => {
    ...
    TwTransfer.vm.addToLeft()
    await nextTick()
    expect(TwTransfer.vm.sourceData.length).toBe(14)
    TwTransfer.vm.addToRight()
    await nextTick()
    expect(TwTransfer.vm.sourceData.length).toBe(12)
  })
