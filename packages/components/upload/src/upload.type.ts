...
export interface TwUploadProgressEvent extends ProgressEvent {
  percent: number
}

export interface TwUploadAjaxError extends Error {
  status: number
  method: string
  url: string
}

export interface TwUploadRequestOptions {
  action: string
  method: string
...
export interface TwUpload extends IUseHandlersProps {
  accept: string
  headers?: Headers
