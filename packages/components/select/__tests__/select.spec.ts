...
describe('Select', () => {
  ...
  test('create', async () => {
    ...
    const select = wrapper.findComponent({ name: 'TwSelect' })
  ...
  test('custom dropdown class', () => {
    ...
    const dropdown = wrapper.findComponent({ name: 'TwSelectDropdown' })
  ...
  test('fitInputWidth', async () => {
    ...
    const selectWrapper = wrapper.findComponent({ name: 'TwSelect' })
  ...
  test('should set placeholder to label of selected option when filterable is true and multiple is false', async () => {
    ...
    const selectVm = wrapper.findComponent({ name: 'TwSelect' }).vm as any
  ...
  test('multiple select with remote load', async () => {
    wrapper = mount({
      ...
      components: { TwSelect: Select, TwOption: Option },
      data() {
        return {
          options: [],
          value: [],
    ...
    const select = wrapper.findComponent({ name: 'TwSelect' }).vm
  ...
  describe('should show all options when open select dropdown', () => {
    async function testShowOptions({ filterable, multiple }: SelectProps = {}) {
      ...
      const options = wrapper.findAllComponents({ name: 'TwOption' })
