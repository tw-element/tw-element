...
- Components [TwCheckboxGroup] add Fragment (#4743 by @emojiiii)

#### Bug fixes

- Components [TwDatePicker] click clear is invalid (#4768 by @emojiiii)
...
- Upgrade @tw-element/icons-vue to currentColor (#4671 by @YunYouJun)
...
- Docs replace @tw-element/icons with @tw-element/icons-vue (#4704 by @pdsuwwz)
...
- Components [TwMenu] the collapsible menu switch will disappear (#4575 by @emojiiii)
- Components [TwScrollbar] fix useResizeObserver watch undefined (#4576 by @emojiiii)
...
- Components [TwSelect] fix group disabled don't work (#4481 by @emojiiii)
...
- Components [TwFormItem] label will be show undefined (#4487 by @emojiiii)
...
- Components TwForm form rule & custom type (#3951 by @Otto-J)
...
- Dev play add @tw-element/icons (#4034 by @xiaoxian521)
...
- Components TwInputNumber (#3974 by @JeremyWuuuuu)
...
- Components TwProgress remove unnecessary required props to prevent form error (#3954 by @Otto-J)
...
- [TwSelectV2] set value to an empty array after selection error (#3875 by @Alanscut)
...
- Add TwSkeleton template scoped parameter `key`. (#2944 by @callmesoul)
...
- Fix TwTable index calculation issue (#2143)
- Fix table test (#2229)
